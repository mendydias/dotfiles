...
return {
	...
	keys = {
		...
		{ "<M-t>", "<cmd>ObsidianTemplate main_template", desc = "Insert Obsidian Template into file" },
	},
	opts = {
		workspaces = {
			{
